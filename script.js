//Curent date + time variable and button variable
...
// create data attributes to each hour input element
...
//write function to render document ready
...
$(document).ready(function () {
    ...
    //  Need current day and date in the jumbotron
    ...
    //  set each timeblock to color code to indicate whether it is in the past, present, or future
    ...
    for (var j = 1; j <= 12; j++) {
        ...
        // Set color in css based on comparisons between the currentTimeInt and the inputTimeInt
    ...
    saveBtn.on("click", function () {
        ...
        // save the user's data entered to local storage
